...
"There are hundreds of them, but as far as I know none of them are any better than Bitcoin, fundamentally. Many of them are utter crap. They're buggy, and most of them are down-right conceptually unsound, I guess what happens when anyone can make their own coin... Then there are some that are technically better than BTC", referring to Bitcoin, Wint knew, "but they're only five percent better, ten percent better and that's not enough to get people of move over, so network-wise Bitcoin is still be best we got."
